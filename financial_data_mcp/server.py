...
_DATA_CATALOG = {
    ...
    "FISIS": {
        ...
        "lrg_div": {
            "은행":    {"A": "국내은행", "J": "외은지점"},
            "보험":    {"H": "생명보험", "I": "손해보험"},
            "금융투자": {"F": "투자매매중개업자I(증권)", "W": "투자매매중개업자II", "G": "집합투자업자(자산운용)", "X": "투자자문일임업자", "D": "종합금융회사", "M": "부동산신탁"},
    ...
    "fisis_registration_status": {
        ...
        "등록_업권": [
            ...
            "투자매매중개업자I-증권사 (lrg_div=F)", "집합투자업자-자산운용사 (lrg_div=G)",
            "종합금융회사 (lrg_div=D)", "상호저축은행 (lrg_div=E)",
            "금융지주회사 (lrg_div=L)",
        ],
        "미등록_DART_단독": [
